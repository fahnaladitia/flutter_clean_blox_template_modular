...
final class SignUpUsecaseParam {
  ...
  SignUpUsecaseParam({required this.email, required this.password, required this.confirmPassword, required this.name}) {
    validate();
  }
  ...
  void validate() {
    ...
    if (name.isEmpty) {
      throw ValidatorException(fieldName: 'name', errMessage: 'Name cannot be empty');
    }
    ...
    final confirmPasswordValidation = Validators.validatePasswordConfirmation(password, confirmPassword);
    if (confirmPasswordValidation != null) {
      throw ValidatorException(fieldName: 'confirm_password', errMessage: confirmPasswordValidation);
    }
  }
}
